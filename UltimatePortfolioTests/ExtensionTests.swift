...
class ExtensionTests: XCTestCase {
    ...
    func test_Sequence_KeyPathSortingBySelfWorks() {
    ...
    func test_Sequence_KeyPathSortingByCustomWorks() {
    ...
    func test_Bundle_DecodingDictionary() {
